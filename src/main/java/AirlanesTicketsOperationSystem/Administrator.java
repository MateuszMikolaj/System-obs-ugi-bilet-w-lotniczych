...
public class Administrator {
    ...
    private static void dodajAsystenta() {
        Scanner input = new Scanner(System.in);
        UserLoginSystem assistant = new UserLoginSystem();

        System.out.println("Podaj login nowego asystenta : ");
        String assistant = input.nextLine();
        System.out.println("Podaj hasło nowego asystenta : ");
        String assistantPassword = input.nextLine();
